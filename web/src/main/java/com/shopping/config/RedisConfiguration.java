...
public class RedisConfiguration extends CachingConfigurerSupport {
    ...
    @Bean
    public MyKeyExpirationEventMessageListener myKeyExpirationEventMessageListener (JedisConnectionFactory jedisConnectionFactory){
        MyKeyExpirationEventMessageListener listener = new MyKeyExpirationEventMessageListener(redisMessageListenerContainer(jedisConnectionFactory));
        return listener;
    }
